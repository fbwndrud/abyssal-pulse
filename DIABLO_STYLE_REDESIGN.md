...
- 성역 노바: 즉발 폭발 후 짧은 성역 장판 생성
- 천상의 창: 회전 빔에서 타깃 관통 창으로 변경
- 룬 방벽: 공전 방어 룬 + 짧은 룬 폭발 장판
- 뼈 파편: 유도탄에서 관통/출혈 뼈창 부채꼴로 변경
- 지옥불 십자: 십자 투사체가 원형 도형 대신 균열형 화염 장판을 남김
- 묘지 가르기: 전방 절단 + 지연 후속 균열 + 출혈
- 저주 번개: 연쇄 피해 + 사망 시 저주 폭발 표식
- 망령 칼날: 관통 후 회귀하는 단검으로 변경
- 심연 우물: 스킬 색을 따르는 흡인장 + 심연 장판
- 영혼 프리즘: 랜덤 분열에서 가까운 적을 찾는 영혼 파편 분열로 변경
